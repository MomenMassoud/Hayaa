...
class VipSectionThree extends StatefulWidget {
  const VipSectionThree({
    super.key,
  });

  @override
  State<VipSectionThree> createState() => _VipSectionThree();
}

class _VipSectionThree extends State<VipSectionThree> {
  ...
  void getVipPrice()async{
    await for(var snap in _firestore.collection('vip').where('id',isEqualTo: 'vip3').snapshots()){
      setState(() {
        ...
        SizedBox(
          ...
          child: Center(
            child: SizedBox(
                ...
                child: const Image(image: AssetImage(AppImages.VIP3))),
          ),
        ),
        Expanded(
          child: ClipPath(
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => SendVip('3', int.parse(coin))));
                              },
                              child: const Text(
                                "ارسال",
