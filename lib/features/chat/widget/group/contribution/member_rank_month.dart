...
class MemberRankMonth extends StatefulWidget{
  String id;
  MemberRankMonth(this.id);
  _MemberRankMonth createState()=>_MemberRankMonth();
}

class _MemberRankMonth extends State<MemberRankMonth>{
  ...
  Widget build(BuildContext context) {
    ...
    return  StreamBuilder<QuerySnapshot>(
      ...
      builder: (context,snapshot){
        ...
        return StreamBuilder<QuerySnapshot>(
          stream: _firestore.collection('family').doc(widget.id).collection('count').snapshots(),
          builder: (context,snapshot){
            if (!snapshot.hasData) {
              return Center(
                child: CircularProgressIndicator(
                          ...
                          child: Row(
                            ...
                            Padding(
                              ...
                              child: TopCard(
                                screenHeight: screenHeight,
                                screenWidth: screenWidth,
                                cardModel: cards[2],coin: coin[2],coinPic: true),
                            ),
                            TopCard(
                              screenHeight: screenHeight,
                              screenWidth: screenWidth,
