...
class MemberRankDay extends StatefulWidget {
  String id;
  MemberRankDay(this.id);
  _MemberRankDay createState() => _MemberRankDay();
}

class _MemberRankDay extends State<MemberRankDay> {
