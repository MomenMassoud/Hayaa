...
class MemberRankAll extends StatefulWidget{
  String id;
  MemberRankAll(this.id);
  _MemebrRankAll createState()=>_MemebrRankAll();
}

class _MemebrRankAll extends State<MemberRankAll>{
